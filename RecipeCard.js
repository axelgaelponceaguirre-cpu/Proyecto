function RecipeCard({ recipe }) {
    // 1. Manejo de error: Si la receta no existe, no intentes renderizar nada.
    if (!recipe) {
        console.error('RecipeCard: No se proporcionó ningún objeto de receta.');
        return null; 
    }

    // 2. Definición de la función de manejo de clic para mejor claridad y depuración.
    const handleRecipeClick = () => {
        // Usamos window.location.href para la navegación directa entre archivos HTML.
        // Aseguramos la ruta con una barra inicial si estás trabajando desde la raíz del proyecto.
        // Si tu setup de rutas es con archivos directos, la ruta relativa es suficiente.
        ...
        >
            ...
            <div className="p-5">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                    ...
                    {/* 3. Llama a la función definida 'handleRecipeClick' */}
                    <button 
